...
$(window).load(function () {
    ...
    var urlList = {};
    urlList.urlThumb = [];
    urlList.urlThumb.push("images/gallery1/full/Depositphotos_10802529_original.jpg");
    urlList.urlThumb.push("images/gallery1/full/Depositphotos_21248859_original.jpg");
    urlList.urlFull = [];
    urlList.urlFull.push("images/gallery1/full/Depositphotos_10802529_original.jpg");
    urlList.urlFull.push("images/gallery1/full/Depositphotos_21248859_original.jpg");

    buildPagination(urlList);
